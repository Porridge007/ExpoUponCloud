	...
	<div id="slider" class="mui-slider" style="width:90%; margin: 0 auto; padding-top: 70px">
		<div class="mui-slider-group mui-slider-loop">
			<div class="mui-slider-item mui-slider-item-duplicate">
				<a href="#">
					<img src="../static/images/lunbo4.png">
				</a>
			</div>
					...
					<ul class="mui-table-view mui-grid-view mui-grid-9">
						<li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-3">
							<a href="#" onclick="javascript:window.location.href='/404'">
								<img src="../static/images/tuijian1.png">
								<p class="gtitle1">2020年6月16日</p>
								<p class="gtitle2">2020浙匠智造</p>
							</a>
						</li>
						<li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-3" style="margin-left:5%">
							<a href="#" onclick="javascript:window.location.href='/404'">
								<img src="../static/images/tuijian2.png">
								<p class="gtitle1">2020年10月16日</p>
								<p class="gtitle2">2020智博会</p>
							</a>
						</li>
						<li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-3" style="margin-left:5%">
							<a href="#" onclick="javascript:window.location.href='/404'">
								<img src="../static/images/tuijian3.png">
								<p class="gtitle1">2020年10月16日</p>
								<p class="gtitle2">2020杭州“美好生活”休闲产业博览会</p>
							</a>
						</li>
					</ul>
				</div>
				<div class="mui-slider-item">
					<ul class="mui-table-view mui-grid-view mui-grid-9">
						<li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-3">
							<a
								href="#">
								<img src="../static/images/tuijian4.jpg">
								<p class="gtitle1">2020年10月16日</p>
			...
			<nav class="mui-bar mui-bar-tab" style="padding-top: 5px;">
				<a id="defaultTab" class="mui-tab-item mui-active" href="html/home.html">
					<svg class="bi bi-house" width="36px" height="36px" fill="currentColor"
						...
						<path
							d="M31.53,14.2a1.09,1.09,0,0,0-.56-.56L17.64.31a1.13,1.13,0,0,0-1.55,0L.32,16.08a1.08,1.08,0,0,0,0,1.54,1.09,1.09,0,0,0,1.55,0l.34-.34v11.8a6.58,6.58,0,0,0,6.57,6.58H25.05a6.58,6.58,0,0,0,6.57-6.58V17.39l.24.23a1.06,1.06,0,0,0,1.54,0,1.08,1.08,0,0,0,0-1.54ZM13.09,33.46v-7a3.52,3.52,0,0,1,7,0v7Zm16.34-4.38a4.38,4.38,0,0,1-4.38,4.38H22.31v-7a5.71,5.71,0,0,0-11.41,0v7H8.78A4.39,4.39,0,0,1,4.4,29.08v-14L16.86,2.63,29.43,15.2Z" />
